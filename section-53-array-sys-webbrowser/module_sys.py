...
# '_deactivate_opcache', '_debugmallocstats', '_enablelegacywindowsfsencoding', '_framework',
...
# 'get_coroutine_origin_tracking_depth', 'get_int_max_str_digits',
# 'getallocatedblocks', 'getdefaultencoding', 'getfilesystemencodeerrors', 'filesystemencoding',
...
# 'stderr', 'stdin', 'stdlib_module_names', 'stdout', 'thread_info', 'unraisablehook', 'version', 'version_info',
# 'warnoptions', 'winver']

# To pass args from terminal -> python module_sys.py username password
print(sys.argv)  # ['module_sys.py', 'username', 'password']
